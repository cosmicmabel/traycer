...
import {
  ...
  mockRemoteHostEntry,
} from "@cic/shared/host-client/mock/mock-host-directory";
...
import type { GuiHarnessId, GuiHarnessOption } from "@cic/protocol/host/index";
import {
...
function buildHost(): MockRunnerHost {
  return new MockRunnerHost({
    signInUrl: "https://sign-in.example.invalid?redirect_uri=cic%3A%2F%2Fauth",
...
const CIC_APP_TEST_TIMEOUT_MS = 30_000;
...
describe("<CicApp />", () => {
  ...
  it(
    ...
    async () => {
      ...
      host.tokenStoreEntries.set("cic.token", {
