...
/**
 * Public shell-agnostic entry point for the CIC GUI.
 *
 ...
 */
export function CicApp(props: CicAppProps): ReactNode {
                  ...
                  >
                    <HostCompatibilityProvider>
                      <RootErrorBoundary router={router}>
                        <CicAuthenticatedRuntime router={router} />
                      </RootErrorBoundary>
                    </HostCompatibilityProvider>
                  </HostRuntimeProvider>
                </KeybindingProvider>
...
interface CicAuthenticatedRuntimeProps {
  readonly router: AppRouter;
}

function CicAuthenticatedRuntime(props: CicAuthenticatedRuntimeProps) {
  return (
                  ...
                  <EpicCanvasPersistLifecycleBridge>
                    ...
                    <HostStreamProvider>
                      <NotificationsSessionProvider>
                        <CicAppRuntimeSurface router={props.router} />
                      </NotificationsSessionProvider>
                    </HostStreamProvider>
                  </EpicCanvasPersistLifecycleBridge>
                </WorktreeIntentStagingPersistLifecycleBridge>
...
interface CicAppRuntimeSurfaceProps {
  readonly router: AppRouter;
}

function CicAppRuntimeSurface(props: CicAppRuntimeSurfaceProps) {
