...
interface CicReferenceChipProps {
...
/**
 * Shared inline chip for the legacy `<cic-*>` reference components. Mirrors
 * the visual treatment of the prior `CicFileReference` chip: a small inline
 ...
 */
export function CicReferenceChip(props: CicReferenceChipProps) {
 ...
 */
function isChatArtifactDragCandidate(props: CicReferenceChipProps): boolean {
  return (
