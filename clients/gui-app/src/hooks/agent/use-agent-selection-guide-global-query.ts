...
import type { AgentSelectionGuideGlobalGetResponse } from "@cic/protocol/host/agent/shared";
 ...
 * default for the active host. Device-scoped: the file lives at ~/.cic/ on
